...
[대학내일 지원 동기]
세대를 읽어 시대를 리드하는 대학내일 미션과 맞닿음. 에이전시 조직의 다양한 직무와 빠른 변화를 HR 관점에서 잘 이해하고 기여할 수 있음. 구성원이 자기다움을 발휘할 수 있는 환경을 만든다는 것이 HR의 본질이라고 믿어왔는데, 그 믿음을 실현할 수 있는 회사라고 생각함. 스타트업에서 처음부터 설계하는 일은 익숙하지만, 더 많은 구성원의 맥락을 다루고 제도가 실제로 뿌리내리는 과정을 경험해야 HR 담당자로 더 단단해질 수 있다고 생각했음.
[답변 규칙]
